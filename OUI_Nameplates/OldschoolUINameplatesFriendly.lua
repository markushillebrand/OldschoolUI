...
local friendlyFrameCache = CreateFramePool("Frame", UIParent, nil, nil, false, function(plate)
    ...
    local BORDER_TEX = "Interface\\AddOns\\OUI_Nameplates\\Media\\border.png"
...
function ns.UpdateFriendlyNameplateSystem()
    ...
    -- Friendly player CVars are only touched when the user has OUI managing
    ...
    -- always managed because they have their own OUI toggle.
...
-------------------------------------------------------------------------------
--  Exported API — called from OUINameplates.lua (NAME_PLATE_UNIT_ADDED/REMOVED)
